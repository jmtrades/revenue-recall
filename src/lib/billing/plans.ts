...
export const PLANS: Plan[] = [
  ...
  },
  {
    ...
    price: "$399",
    cadence: "/rep/mo",
    features: ["Everything in Starter", "Live AI across email, SMS & the phone", "1,500 talk minutes — covers ~100 dials a day (no-answers free)", "Autopilot sequences that work the pipeline", "~1,500 AI messages / mo (emails, texts & calls it writes)", "AI call prep + auto-logged outcomes", "Connect any CRM · unlimited pipelines"],
    purchasable: true,
    perSeat: true,
  },
  {
    ...
    price: "$899",
    cadence: "/mo",
    features: ["Everything in Operator", "Up to 5 reps · ~10,000 AI messages / mo pooled", "4,000 talk minutes pooled — ~6,000 dials a month", "Batch drafting engine (higher volume, lower cost)", "Team analytics + recovered-revenue reporting", "Priority queue & support", "Advanced automations"],
    purchasable: true,
    perSeat: false,
  },
  {
