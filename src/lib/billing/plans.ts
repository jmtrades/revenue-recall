...
export const PLANS: Plan[] = [
  ...
  },
  {
    id: "growth",
    name: "Operator",
    blurb: "One autonomous AI rep, working 24/7 — for less than a day of an SDR's salary.",
    price: "$599",
    cadence: "/rep/mo",
    features: ["Everything in Starter", "Live AI across email, SMS & the phone — in a premium, human voice", "1,500 talk minutes — ~100 dials every business day (no-answers are free)", "~1,500 AI messages / mo it writes & sends (emails, texts & call scripts)", "Autopilot sequences that work your pipeline while you sleep", "AI call prep + auto-logged outcomes straight to the CRM", "Connect any CRM · unlimited pipelines", "Buy a working phone number in-app · top up anytime"],
    purchasable: true,
    perSeat: true,
  },
  {
    id: "team",
    name: "Autopilot",
    blurb: "An autonomous sales team for your whole desk — a fraction of one rep's cost.",
    price: "$1,699",
    cadence: "/mo",
    features: ["Everything in Operator", "Up to 5 reps · ~6,000 AI messages / mo pooled across the desk", "4,000 talk minutes pooled — ~6,000 dials a month in a real human voice", "Batch drafting engine — higher volume, lower cost per message", "Team analytics + recovered-revenue reporting (see exactly what it won back)", "Priority queue & support", "Advanced automations & multi-number routing"],
    purchasable: true,
    perSeat: false,
  },
  {
