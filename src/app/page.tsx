...
const FAQ = [
  ...
  { q: "How does pricing work?", a: "Per seat, monthly or annual (save 20%). Each paid seat includes a monthly pool of AI actions — Growth 800, Scale 2,000. Calls and SMS are billed as usage credits at near cost, and you can top up AI credits anytime. Starter is free, no credit card." },
  { q: "What counts as an AI action?", a: "Anything the AI does for you: drafting an email or text, prepping a call, or summarizing an outcome. Starter includes 50/mo so you can try it; Growth includes 800 per seat and Scale 2,000, with credits available beyond that." },
