  ...
  return (
    <section className="relative overflow-hidden rounded-2xl border border-brand/40 bg-gradient-to-r from-brand-soft/50 via-surface to-surface p-5 ring-glow">
      <div className="flex flex-wrap items-center gap-4">
        <span className="grid h-11 w-11 flex-none place-items-center rounded-xl bg-brand-strong text-white shadow-[inset_0_1px_0_0_rgb(255_255_255/0.35)]">
        ...
        <div className="flex flex-none flex-col items-stretch gap-1.5 sm:items-end">
          <Link
            ...
            className="cta inline-flex items-center justify-center gap-1.5 rounded-full bg-brand-strong px-5 py-2.5 text-sm font-semibold text-white hover:bg-brand-strong/90"
          >
            Turn on Autopilot
          </Link>
          <span className="text-center text-[11px] text-muted sm:text-right">From $599/mo · cancel anytime</span>
        </div>
      </div>
    </section>
  );
