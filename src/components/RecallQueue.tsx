            ...
            {draft.busy ? (
              ...
              <>
                ...
                <div className="mt-3 flex items-center justify-between">
                  <span className="text-[11px] text-muted">{draft.source === "ai" ? "Generated by Claude" : draft.source === "error" ? "Couldn't draft — try Regenerate" : "Template — connect AI for tailored drafts"}</span>
