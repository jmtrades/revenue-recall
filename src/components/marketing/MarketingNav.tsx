    ...
    <header className="sticky top-0 z-40 border-b border-border/60 bg-bg/70 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-5">
        ...
        <nav className="hidden items-center gap-7 text-sm text-muted md:flex">
          ...
          <a href="#industries" className="transition hover:text-fg">Industries</a>
          <a href="#pricing" className="transition hover:text-fg">Pricing</a>
        </nav>
        <div className="flex items-center gap-2">
          <Link href="/login" className="rounded-lg px-3 py-2 text-sm text-muted transition hover:text-fg">Sign in</Link>
